...
val menuSkbFunsPreset: Map<SkbMenuMode, SkbFunItem> = hashMapOf(
    ...
    // SkbMenuMode.FloatKeyboard removed
    // FlowerTypeface removed to hide the feature from menus
    ...
    SkbMenuMode.PinKeyboardToSecondary to SkbFunItem(Launcher.instance.context.getString(R.string.menu_pin_keyboard_secondary), R.drawable.ic_menu_dualscreen, SkbMenuMode.PinKeyboardToSecondary),
    )